...
fn migrated_payload_paths_avoid_full_buffer_reads() {
    ...
    let targets = [
        ...
        GuardTarget {
            relative_path: "crates/rom-weaver-cli/src/trim_detection.rs",
            forbidden: &["fs::read("],
            allowlist_fragments: &[],
        },
        GuardTarget {
            relative_path: "crates/rom-weaver-cli/src/trim_execution.rs",
            forbidden: &["fs::read("],
            allowlist_fragments: &[],
        },
        GuardTarget {
        ...
        GuardTarget {
            relative_path: "packages/rom-weaver-webapp/src/wasm/browser-opfs-mounts.ts",
