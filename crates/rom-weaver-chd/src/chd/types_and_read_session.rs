...
impl ChdReadSession {
    ...
    fn open_rust(source: &Path, parent_source: Option<&Path>) -> std::result::Result<Self, String> {
...
use create_encoding::{CD_SYNC_HEADER, ChdCompressionScratch};
