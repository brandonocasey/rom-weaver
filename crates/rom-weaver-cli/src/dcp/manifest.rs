...
//!
//! DCP has no manifest file; ZIP entry names encode each operation:
//!
//! - `bootsector/IP.BIN`: replacement bootstrap, excluded from the filesystem.
//! - `PATH.xdelta`: VCDIFF against the same-named source file.
//! - anything else: a verbatim filesystem file.
