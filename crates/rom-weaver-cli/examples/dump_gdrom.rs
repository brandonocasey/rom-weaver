...
//! files.
//!
//! List:    `cargo run -p rom-weaver-cli --example dump_gdrom -- <track.bin> [start_lba]`
//! Extract: `cargo run -p rom-weaver-cli --example dump_gdrom -- <track.bin> <start_lba> <NAME> <out>`
