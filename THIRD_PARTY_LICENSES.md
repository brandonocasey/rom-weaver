...
| `aes` | `0.9.0` | `MIT OR Apache-2.0` | `crates.io` |
| `aho-corasick` | `1.1.4` | `Unlicense OR MIT` | `crates.io` |
| `akv` | `0.1.0` | `MIT OR Apache-2.0` | `local` |
...
| `nod` | `2.0.0-alpha.10` | `MIT OR Apache-2.0` | `local` |
