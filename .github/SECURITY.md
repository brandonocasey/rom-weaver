...
or provide hashes and enough structural detail to reproduce the problem.

Issues involving archive or image parsing, path handling, browser storage,
cross-origin isolation, or untrusted patch processing are in scope.
