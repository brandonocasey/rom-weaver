...
// Per-input read strategy: Chrome/Firefox and small WebKit inputs use parallel
// FileReaderSync readers; large WebKit inputs use one proxy reader because the
// engine serializes same-File reads. The mount selects its inode from this flag.
