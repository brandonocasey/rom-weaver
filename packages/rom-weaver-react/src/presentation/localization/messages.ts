...
const MESSAGES: Record<MessageId, MessageDescriptor> = {
  ...
  "ui.manifestExport.description": msg({ id: "ui.manifestExport.description", message: "Description" }),
  "ui.manifestExport.error": msg({ id: "ui.manifestExport.error", message: "Manifest export failed" }),
  "ui.manifestExport.export": msg({ id: "ui.manifestExport.export", message: "Export" }),
  "ui.manifestExport.exporting": msg({ id: "ui.manifestExport.exporting", message: "Exporting manifest…" }),
  "ui.manifestExport.format.bundle": msg({
    id: "ui.manifestExport.format.bundle",
    message: "{format} bundle (manifest + patches)",
  }),
  "ui.manifestExport.format.manifestOnly": msg({
    id: "ui.manifestExport.format.manifestOnly",
    message: "Manifest only (rw.json)",
  }),
  "ui.manifestExport.fromArchive": msg({ id: "ui.manifestExport.fromArchive", message: "from {name}" }),
  "ui.manifestExport.name": msg({ id: "ui.manifestExport.name", message: "Manifest name" }),
  "ui.manifestExport.output": msg({ id: "ui.manifestExport.output", message: "Output" }),
  "ui.manifestExport.patchChecks": msg({
    id: "ui.manifestExport.patchChecks",
    message: "ROM checks (pre-apply)",
  }),
  "ui.manifestExport.patches": msg({ id: "ui.manifestExport.patches", message: "Patches" }),
  "ui.manifestExport.preparing": msg({
    id: "ui.manifestExport.preparing",
    message: "Preparing patch files…",
  }),
  "ui.manifestExport.status.default": msg({ id: "ui.manifestExport.status.default", message: "Default (on)" }),
  "ui.manifestExport.status.disabled": msg({ id: "ui.manifestExport.status.disabled", message: "Disabled" }),
  "ui.manifestExport.status.optional": msg({ id: "ui.manifestExport.status.optional", message: "Optional (off)" }),
  "ui.manifestExport.status.required": msg({ id: "ui.manifestExport.status.required", message: "Required" }),
  "ui.manifestExport.statusLabel": msg({ id: "ui.manifestExport.statusLabel", message: "Patch {n} status" }),
  "ui.manifestExport.title": msg({ id: "ui.manifestExport.title", message: "Export manifest" }),
  "ui.manifestSession.requiredLock": msg({
    id: "ui.manifestSession.requiredLock",
    message: "Required by the manifest",
  }),
