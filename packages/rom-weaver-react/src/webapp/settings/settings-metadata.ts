...
const SETTINGS_FIELD_METADATA: { [K in SettingsFieldKey]: SettingsFieldMetadata<K> } = {
  ...
  compressionProfile: {
    ...
    max: 4,
    min: 0,
    scaleLabels: ["Min", "Low", "Medium", "High", "Max"],
    step: 1,
    suggestion: "Default: Max. RVZ/7z zstd levels: 0, 5, 12, 19, 22. ZIP/other levels: 0, 3, 5, 7, 9.",
    suggestionDataLocalize: "Default: Max. RVZ/7z zstd levels: 0, 5, 12, 19, 22. ZIP/other levels: 0, 3, 5, 7, 9.",
