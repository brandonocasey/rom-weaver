...
| PAT-017 | patch | SPATCH (Double IPS) | todo | n/a | n/a | todo | todo | scan,diff,write flags | fixture-parity,cli-smoke | todo | Support intentionally removed: `.spatch` probing and `double-ips`/`doubleips` alias routing are no longer registered. |
