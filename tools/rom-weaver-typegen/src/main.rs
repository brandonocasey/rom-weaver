...
use rom_weaver_app::{
    ...
    ManifestCreateCommand, ManifestCreateResult, ManifestOutput, ManifestParseCommand,
    ManifestParseResult, ManifestPatchEntry, ManifestPatchSource, ManifestPatchStatus, ManifestRom,
    ManifestSourceKind, ManifestSourceRef, MatchSidecarsCommand, N64ByteOrder, PatchApplyCommand,
    PatchApplyHeaderMode, PatchApplyOutputHeaderMode, PatchCommands, PatchCreateCandidatesCommand,
    PatchCreateCommand, PatchDescriptor, PatchValidateCommand, PlanExtractBatchCommand,
    ProbeCommand, RomWeaverManifest, RomWeaverRunOutputOptions, RomWeaverRunRequest, TrimCommand,
