...
const [platform, binaryPath = resolve(repoRoot, "target/release/rom-weaver")] = process.argv.slice(2);

if (!platform) throw new Error("usage: node scripts/prepare-npm-platform-package.mjs <platform> [binary]");
